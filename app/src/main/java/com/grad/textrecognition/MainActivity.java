package com.grad.textrecognition;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void recognizeTextFromImage() {
        ...
        try {
            ...
            Toast.makeText(this, "Failed preparing iamge due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void pickiamgeGallery() {
        Log.d(TAG, "pickiamgeGallery: ");
